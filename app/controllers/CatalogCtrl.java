...
public class CatalogCtrl extends Controller {
...
//
    ...
    public Result query(Integer page, Integer perPage, String filters) throws ServiceException {
        ...
        JavaServiceResult jsr = getServiceJava.count(LcCatalog.class, filters);
        ...
        return queryServiceRest.query(LcCatalog.class, page, perPage, filters ).buildPlayCtrlResult();
    }
