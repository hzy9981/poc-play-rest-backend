...
public class LinkCtrl extends Controller {
...
//
    ...
    public Result query(Integer page, Integer perPage, String filters) throws ServiceException {
        ...
        JavaServiceResult jsr = getServiceJava.count(LcLink.class, filters);
        ...
        return queryServiceRest.query( LcLink.class, page, perPage, filters ).buildPlayCtrlResult();
    }
