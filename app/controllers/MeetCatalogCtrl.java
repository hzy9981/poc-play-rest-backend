...
import models.meet.LcMeetCatalog;
...
public class MeetCatalogCtrl extends Controller {
...
//
    ...
    public Result query(Integer page, Integer perPage, String filters) throws ServiceException {
        ...
        JavaServiceResult jsr = getServiceJava.count(LcMeetCatalog.class, filters);
        ...
        return queryServiceRest.query( LcMeetCatalog.class, page, perPage, filters ).buildPlayCtrlResult();
    }
