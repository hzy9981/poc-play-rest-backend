...
public class SliderCtrl extends Controller {
...
//
    ...
    public Result query(Integer page, Integer perPage, String filters) throws ServiceException {
        ...
        JavaServiceResult jsr = getServiceJava.count(LcSlider.class, filters);
        ...
        return queryServiceRest.query( LcSlider.class, page, perPage, filters ).buildPlayCtrlResult();
    }
